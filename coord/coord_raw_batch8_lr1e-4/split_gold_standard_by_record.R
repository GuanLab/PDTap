...
demographic = read.table('../Demographic.tsv', sep="\t", header=T, stringsAsFactors=F)
tapping = read.table('../Tapping_activity_training.tsv', sep="\t", header=T, stringsAsFactors=F)
